...
CREATE
    DATABASE /*!32312 IF NOT EXISTS */`ship` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert into `t_plugin`(`id`, `name`, `code`, `description`, `created_time`)
values (1, '动态路由', 'DynamicRoute', '动态路由插件', '2020-12-29 09:48:20');
INSERT INTO `t_plugin`(`id`, `name`, `code`, `description`, `created_time`)
VALUES (2, '鉴权', 'Auth', '鉴权插件', '2020-12-29 09:48:20');
...
insert into `t_user`(`id`, `user_name`, `password`, `created_time`)
values (1, 'admin', '6b249962c7fa2a4b2ba26474dd164c3c', '2021-01-04 11:36:54');
